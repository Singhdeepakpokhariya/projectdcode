              ...
              <div className="row">
                <div className="settingHead my-3 d-flex flex-direction-row  ">
                  <div className="d-flex  ">
                    <p style={{ color: "lightgray" }}>&lt; Back to Profile</p>
                  </div>
                  <p className="my-3 ">
                    <strong>
                ...
                <div className="d-flex flex-direction-row mx-5 settingBody">
                  <div className="notificationSetting mx-5 my-4 ">
                    ...
                    <div className="d-flex">
                      &nbsp;&nbsp;&nbsp;{shareWebProfile}&nbsp;&nbsp;&nbsp;
                      <p>Share the web profile link</p>
                    </div>
                    <hr />
                    <div className="d-flex">
                      &nbsp;&nbsp;&nbsp;{share}&nbsp;&nbsp;&nbsp;
                      <p>Share leaderboard Image</p>
                    </div>
                    <hr />
                    <div className="d-flex">
                      &nbsp;&nbsp;&nbsp;{rate}&nbsp;&nbsp;&nbsp;
                      <p>Rate us on App store</p>
                    </div>
                    <hr />
                    <div className="d-flex">
                      &nbsp;&nbsp;&nbsp;{like}&nbsp;&nbsp;&nbsp;
                    ...
                    <div className="d-flex">
                      &nbsp;&nbsp;&nbsp;{Referral}&nbsp;&nbsp;&nbsp;
                      <p>Referral/Refer Codes system</p>
                    </div>
                    <hr />
                  </div>
